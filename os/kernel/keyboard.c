...
{
	ComboKey ck;
	ck.key = kernelReadKey();
	ck.ctrl_l_status = ctrl_l_status;
	ck.ctrl_r_status = ctrl_r_status;
	ck.shift_l_status = shift_l_status;
	ck.shift_r_status = shift_r_status;
	ck.alt_l_status = alt_l_status;
	ck.alt_r_status = alt_r_status;
	return ck;
}
