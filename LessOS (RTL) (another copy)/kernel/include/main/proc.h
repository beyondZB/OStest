...
//state value
#define PROC_STATE_ILLEGAL	0
#define PROC_STATE_RUNNING	1
#define PROC_STATE_READY	2
#define PROC_STATE_BLOCKING	3

// number of tasks
#define	NR_TASKS		3
#define NR_PROC			5	/* NR_PROC >= NR_TASKS */

/* stacks of tasks */
#define STACK_SIZE_IDLE		0x8000
#define STACK_SIZE_TESTA	0x8000
#define STACK_SIZE_TESTB	0x8000
#define STACK_SIZE_USER		0x8000
#define KERNEL_STACK_SIZE_IDLE	0x8000
#define KERNEL_STACK_SIZE_TESTA	0x8000
#define KERNEL_STACK_SIZE_TESTB	0x8000
#define KERNEL_STACK_SIZE_USER	0x8000


/* user code area */
#define USER_PROCESS_POS	0x800000
#define USER_PROCESS_EIP	0x700000

#define STACK_SIZE_TOTAL  	(NR_PROC * 0x8000)
#define KERNEL_STACK_SIZE_TOTAL (NR_PROC * 0x8000)
