...
#define NR_SCAN_CODES	0xB8	/* Number of scan codes (rows in keymap) */

#define FLAG_BREAK	0x80		/* Break Code			*/
#define FLAG_EXT	0x80		/* Normal function keys		*/
...
#define PRNTSCR		(0x3C + FLAG_EXT)	/* PRNTSCR */
...
/* 修饰键状态 */
#define	VKEY_STATE_PRESSED	TRUE	
#define VKEY_STATE_RELEASED	FALSE
